...
var _user$project$Stop$Remove = {ctor: 'Remove'};
			...
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$html$Html_Attributes$value(model.mtaStopId),
	...
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Events$onClick(_user$project$Stop$Remove)
					]),
				_elm_lang$core$Native_List.fromArray(
					[
...
var _user$project$Stop$main = {
	main: _elm_lang$html$Html_App$program(
		{
			init: {ctor: '_Tuple2', _0: _user$project$Stop$initialModel, _1: _elm_lang$core$Platform_Cmd$none},
			view: _user$project$Stop$view,
			update: _user$project$Stop$update,
			subscriptions: _user$project$Stop$subscriptions
		})
};
			...
			default:
				...
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{token: _p3}),
					_1: _user$project$Main$setToken(_p3)
				};
		}
	});
